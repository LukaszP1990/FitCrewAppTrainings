...
import com.fitcrew.FitCrewAppTrainings.converter.TrainingDtoTrainingModelConverterImpl;
...
class TrainingServiceTest {
    ...
    private TrainingDocumentTrainingDtoConverter trainingDocumentDtoConverter = new TrainingDocumentTrainingDtoConverterImpl();
    private TrainingDtoTrainingModelConverter trainingDtoModelConverter = new TrainingDtoTrainingModelConverterImpl();

    private TrainingService trainingService =
			new TrainingService(trainingDao, trainingDocumentDtoConverter, trainingDtoModelConverter);
    ...
    void shouldCreateTraining() {
        ...
        Either<ErrorMsg, TrainingModel> createdTraining =
    ...
    void shouldNotCreateTraining() {
        ...
        Either<ErrorMsg, TrainingModel> noTrainingCreated =
                trainingService.createTraining(mockedTrainingDto);
